...
export default function Sidebar({
  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-screen bg-[#f5f5f7] border-r border-[#ececec] shadow-[0_0_40px_rgba(0,0,0,0.04)] flex flex-col transition-all duration-300 ${collapsed ? "w-[72px]" : "w-[280px] pl-2"
        }`}
    >
      ...
      <div className="border-t border-[#ececec] bg-[#f7f7f8] pt-2 px-2 mb-2">
        ...
        <SignOutNavItem collapsed={collapsed} onSignOut={handleSignOut} />
    ...
    <div className="relative group">
      <button
        ...
        className={`flex items-center w-full ${collapsed ? "justify-center" : "gap-2 px-2"
          } py-2 rounded-2xl text-sm transition-all duration-150 hover:scale-[1.02] text-[#616161] hover:bg-white/80 hover:text-black`}
      >
        <LogOut size={16} />
